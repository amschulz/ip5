...
import datetime
# 50 best selling articles were computed before. Because the duration was about 1h we decided to hardcode the list in here.
...
# itearte over the years and get prediction
